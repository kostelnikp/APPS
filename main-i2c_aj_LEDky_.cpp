	...
	/*void on_tick()
	 {
	  ...
	  static bool PTC9_index = false;
	  static int l_tick = 0;
	  static int l_tick_move = 0;
	  static int jas = 100;
	  static bool PTC10_index = false;
